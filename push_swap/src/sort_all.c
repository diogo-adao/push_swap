...
void final_sort(t_stacks *stacks)
{
    ...
    {
        cheap = find_cheapest(stacks->stacka, stacks->size_a, stacks->stackb, stacks->size_b);
        cost_a = calculate_cost_for_stack_a(cheap, stacks->size_a);
        cost_b = calculate_cost_for_stack_b(stacks->stacka[cheap], stacks->stackb, stacks->size_b);
